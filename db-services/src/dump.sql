...
create table students ( student_id int unsigned not null auto_increment, student_name varchar(50) not null, student_class VARCHAR(30) not null, constraint pk_students primary key (student_id)) ENGINE=INNODB;
insert into students (student_name, student_class) values ('RAJ', 'CLASS II');
insert into students (student_name, student_class) values ('RAJA BABU', 'CLASS III');
insert into students (student_name, student_class) values ('NANDU', 'CLASS IV');
insert into students (student_name, student_class) values ('NANDU SABKA BANDHU', 'CLASS V');
